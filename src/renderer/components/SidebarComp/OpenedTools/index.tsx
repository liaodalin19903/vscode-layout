...
// 基于是否收藏，更新工具名称
const updateToolnameBaseOnIsCollected = (lmtTreeData) => {
...
function index() {
  ...
  return (
    <div className={styles.OpenedtoolsContainer}>
      <div className={styles.OpenedtoolsHeaderContainer}>已打开的工具</div>
